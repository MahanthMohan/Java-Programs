...
public class TrigonometricFunctions {
	static double adj,opp,hyp,result;static int op,subop;
	...
	{
		Method.getData();
		System.out.println("What do you want to calculate - Sine(1),Cosine(2),Tangent(3),Cosecant(4),Secant(5),and Cotangent(6)");
